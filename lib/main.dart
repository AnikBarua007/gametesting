  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: accentColor.withValues(alpha: isHiddenHand ? 0.8 : 0.65),
          width: isHiddenHand ? 1.8 : 1.3,
        ),
        boxShadow: <BoxShadow>[
          BoxShadow(
            color: accentColor.withValues(alpha: isHiddenHand ? 0.25 : 0.20),
            blurRadius: 18,
            spreadRadius: 1,
          ),
        ],
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    constraints: BoxConstraints(maxWidth: artwork != null ? 165 : 240),
                    child: Text(
                      game?.description ??
                          (isHiddenHand
